...
#ifndef APRILTAG_MSGS__MSG__APRIL_TAG_DETECTION_ARRAY_H_
#define APRILTAG_MSGS__MSG__APRIL_TAG_DETECTION_ARRAY_H_
...
#endif  // APRILTAG_MSGS__MSG__APRIL_TAG_DETECTION_ARRAY_H_
